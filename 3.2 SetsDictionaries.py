...
#     dictionary = dict({"digits": 0, "units": 0, "zeros": 0})
#     string = f"{number:b}"
#     dictionary["digits"] = len(string)
#     for i in string:
#         if int(i) == 1:
#             dictionary["units"] += 1
#         else:
...
# print(formated_json := json.dumps(arr, indent=4))
...
#         while True:
#             try:
#                 index_of_zaika = string.index("зайка")
#                 if 'зайка' == string[0]:
#                     myset.add(string[1])
#                     string.remove(string[index_of_zaika])
#                 elif 'зайка' == string[-1]:
#                     myset.add(string[index_of_zaika - 1])
#                     string.remove(string[index_of_zaika])
#                 else:
#                     left_word, right_word = string[index_of_zaika - 1], string[index_of_zaika + 1]
#                     myset.update([left_word, right_word])
#                     string.remove(string[index_of_zaika])
#             except ValueError:
#                 break                
#     else:
